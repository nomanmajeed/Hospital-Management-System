 ...
 * @author NOMAN
 */
public class IndoorReview extends javax.swing.JFrame {

    public IndoorReview() {
        initComponents();
    }
    public IndoorReview(String data) {
        initComponents();
    ...
    private void initComponents() {
        ...
        review.setText("Indoor Patient Data Review");
        jPanel1.add(review);
