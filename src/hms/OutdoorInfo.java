 ...
 * @author NOMAN
 */
public class OutdoorInfo extends javax.swing.JFrame {

    public OutdoorInfo() {
        initComponents();
    }
    public OutdoorInfo(String data, String file){
        initComponents();
    ...
    private void initComponents() {
        ...
        review.setText("Outdoor Patient Information");
        jPanel1.add(review);
    ...
    public static void main(String args[]) {
        new OutdoorInfo().setVisible(true);
