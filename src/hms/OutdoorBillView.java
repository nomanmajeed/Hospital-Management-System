 ...
 * @author NOMAN
 */
public class OutdoorBillView extends javax.swing.JFrame {

    public OutdoorBillView() {
        initComponents();
    }
    public OutdoorBillView(String data) {
        initComponents();
        bill.setText(data);
    ...
    private void initComponents() {
        ...
        OutdoorBillView = new javax.swing.JLabel();
        ...
        OutdoorBillView.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        OutdoorBillView.setForeground(new java.awt.Color(0, 102, 102));
        OutdoorBillView.setText("Outdoor Patient Bill View");
        jPanel2.add(OutdoorBillView);
        OutdoorBillView.setBounds(230, 20, 225, 22);
    ...
    private javax.swing.JLabel OutdoorBillView;
